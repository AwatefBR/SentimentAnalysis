...
<html style="font-size: 16px;" lang="fr"><head>
    ...
    <link rel="stylesheet" href="/static/Accueil.css" media="screen">
  ...
  <meta data-intl-tel-input-cdn-path="/static/intlTelInput/"></head>
  <body data-path-to-root="./" data-include-products="false" class="u-body u-xl-mode" data-lang="fr"><header class="u-clearfix u-gradient u-header u-header" id="sec-c8c2"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-align-center u-clearfix u-white u-section-1" id="carousel_5e7e">
      ...
      <div class="u-form u-radius-20 u-white u-form-1">
        <form action="https://forms.nicepagesrv.com/v2/form/process" class="u-clearfix u-form-spacing-15 u-form-vertical u-inner-form" source="email" name="form" style="padding: 23px;">
          <h4 class="u-align-center u-form-group u-form-text u-text u-text-1"> &nbsp;​​Write your post !<span style="text-decoration: underline !important;"></span>
          </h4>
    ...
    <footer class="u-align-center u-clearfix u-footer u-gradient u-footer" id="sec-49c9"><div class="u-clearfix u-sheet u-sheet-1"></div></footer>
